...
const ProductModal = (function () {
  ...
  // CSS ARTIK BU DOSYADA DEĞİL — css/product-detail.css (bkz. o dosyanın başı). Burada yalnızca
  ...
  function injectStyles() {
    const href = '/css/product-detail.css';
    if (document.querySelector(`link[rel="stylesheet"][href^="${href}"]`)) return;
    const link = document.createElement('link');
    link.rel = 'stylesheet';
    link.href = href;
    link.id = 'product-modal-styles';
  ...
  const RIGHT_TEMPLATE = `
    ...
    <p class="source-disclaimer" id="pdm-source-disclaimer">Kamuya açık kaynaklardan derlenmiştir, doğrulanmamıştır. Yanlışlık olduğunu düşünüyorsan <a href="mailto:info@mimarlab.com">info@mimarlab.com</a> adresinden bize ulaş!</p>
  ...
  async function renderItem(p, key) {
    ...
    ModalShell.setSourceDisclaimer('pdm-source-disclaimer', p.claimed);
