...
const ProjectModal = (function () {
  ...
  const RIGHT_TEMPLATE = `
    ...
    <p class="source-disclaimer" id="pm-source-disclaimer">Kamuya açık kaynaklardan derlenmiştir, doğrulanmamıştır. Yanlışlık olduğunu düşünüyorsan <a href="mailto:info@mimarlab.com">info@mimarlab.com</a> adresinden bize ulaş!</p>
