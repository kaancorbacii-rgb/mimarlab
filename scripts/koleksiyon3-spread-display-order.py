#!/usr/bin/env python3
"""Koleksiyon 3. partisinin 52 ürününü katalog sayfalarına eşit aralıklarla serpiştirir.

koleksiyon2-spread-display-order.py'nin eşi, TEK farkla: orada yalnızca YENİ eklenen satırlar
serpiştiriliyordu; burada YENİ (18) + REVİZE EDİLEN (34) satırların HEPSİ yeniden dağıtılır —
...
Önkoşul: import-koleksiyon3.py çalışmış ve koleksiyon3-import-report.json üretilmiş olmalı.

Kullanım:
  python3 scripts/koleksiyon3-spread-display-order.py [--dry-run]
"""
import argparse
...
def main():
    ...
    # Parti sırası = rapordaki sıra (koleksiyon3-build-payload.py#shuffle_by_category ile zaten
